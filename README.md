**Amazing news** - навык для Яндекс.Алисы, написанный с использованием yandex-dialogs-sdk. В формате простой викторины пользователю предлагается угадать правдива новость или нет.
